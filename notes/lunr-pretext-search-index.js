...
},
{
  "id": "sec-fin-rev",
  "level": "1",
  "url": "sec-fin-rev.html",
  "type": "Worksheet",
  "number": "",
  "title": "Final Review Information",
  "body": " Final Review Information   Final Review   The following comments and conceptual questions are intended to help you review important ideas covered on the final. You should use them, along with portfolio questions and the midterms to guide your studying and creation of a single note sheet that can be used during the in-class final. I consider the creation of a note sheet for a cumulative final like this a very important part of your studying. Focus on the quality of what will actually help you, not on the quantity. What concepts were emphasized on the midterms? What did you struggle with most?     Midterm 1 material: the midterm itself is the best resource to guide your review. The topics from the midterm that were either the most widely missed or the most widely used in our course (and thus the most important for assessing) are   Proofs regarding injectivity\/surjectivity of functions (particularly under composition). See problem 4 of midterm 1.    Set arguments to show one set is contained in another. See problems 2 and 5 of midterm 1.    Understanding the Completeness Axiom, and proving properties and uniqueness of supremums\/infimums. See problems 6, 7, and 8 of midterm 1.    Understanding basic properties of the real numbers. See problem 9 of midterm 1.       Midterm 2 material: the midterm itself is the best resource to guide your review. The topics from the midterm that were either the most widely missed or the most widely used in our course (and thus the most important for assessing) are   Identifying open, closed, compact, and connected sets, and identifying accumulation points of sets. See problem 1 of midterm 2.    Proving the monotone convergence theorem. See problems 3 of midterm 2.    Justifying that a function is discontinuous using various characterizations of continuity (particularly the epsilon-delta characterization and the characterization using preimages). See problem 5 of midterm 2.    Using the extreme value theorem and the intermediate value theorem. See problem 6 of midterm 2.       New Material: topics from chapters 8 and 9 to focus on are   Knowing and using the limit definition of derivative to determine if a function is differentiable at a point.    Understanding the relationship between differentiability and continuity.    Using the mean value theorem.    Computing upper and lower sums for a function for a given partition (both regular and not regular).    Determining whether a function is integrable on a given interval by thinking about upper and lower integrals.    Knowing particular classes of functions that we have proven are always integrable on a closed bounded interval.    Knowing and using the fundamental theorem of calculus (recall there are 2 statements!).          "
},
{
  "id": "sec-fin-rev-2",
  "level": "2",
  "url": "sec-fin-rev.html#sec-fin-rev-2",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "Final Review.",
  "body": " Final Review   The following comments and conceptual questions are intended to help you review important ideas covered on the final. You should use them, along with portfolio questions and the midterms to guide your studying and creation of a single note sheet that can be used during the in-class final. I consider the creation of a note sheet for a cumulative final like this a very important part of your studying. Focus on the quality of what will actually help you, not on the quantity. What concepts were emphasized on the midterms? What did you struggle with most?     Midterm 1 material: the midterm itself is the best resource to guide your review. The topics from the midterm that were either the most widely missed or the most widely used in our course (and thus the most important for assessing) are   Proofs regarding injectivity\/surjectivity of functions (particularly under composition). See problem 4 of midterm 1.    Set arguments to show one set is contained in another. See problems 2 and 5 of midterm 1.    Understanding the Completeness Axiom, and proving properties and uniqueness of supremums\/infimums. See problems 6, 7, and 8 of midterm 1.    Understanding basic properties of the real numbers. See problem 9 of midterm 1.       Midterm 2 material: the midterm itself is the best resource to guide your review. The topics from the midterm that were either the most widely missed or the most widely used in our course (and thus the most important for assessing) are   Identifying open, closed, compact, and connected sets, and identifying accumulation points of sets. See problem 1 of midterm 2.    Proving the monotone convergence theorem. See problems 3 of midterm 2.    Justifying that a function is discontinuous using various characterizations of continuity (particularly the epsilon-delta characterization and the characterization using preimages). See problem 5 of midterm 2.    Using the extreme value theorem and the intermediate value theorem. See problem 6 of midterm 2.       New Material: topics from chapters 8 and 9 to focus on are   Knowing and using the limit definition of derivative to determine if a function is differentiable at a point.    Understanding the relationship between differentiability and continuity.    Using the mean value theorem.    Computing upper and lower sums for a function for a given partition (both regular and not regular).    Determining whether a function is integrable on a given interval by thinking about upper and lower integrals.    Knowing particular classes of functions that we have proven are always integrable on a closed bounded interval.    Knowing and using the fundamental theorem of calculus (recall there are 2 statements!).         "
}
]
